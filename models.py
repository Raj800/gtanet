...
def otherception3(width, height, frame_count, lr, output=9, model_name='otherception.model', device='gpu', num='0'):
    with tf.device('/{}:{}'.format(device, num)):
        ...
        inception_3a_3_3 = conv_2d(inception_3a_3_3_reduce, 128, filter_size=12, activation='relu',
        ...
        inception_3a_5_5 = conv_2d(inception_3a_5_5_reduce, 32, filter_size=15, activation='relu',
        ...
        inception_3b_3_3 = conv_2d(inception_3b_3_3_reduce, 192, filter_size=9, activation='relu',
...
def inception_v3_3d(width, height, frame_count, lr, output=9, model_name='sentnet_color.model'):
    ...
    # merge the inception_3b_*
    inception_3b_output = merge([inception_3b_1_1, inception_3b_3_3, inception_3b_5_5, inception_3b_pool_1_1],
                                mode='concat', axis=4, name='inception_3b_output')
    ...
    inception_4a_output = merge([inception_4a_1_1, inception_4a_3_3, inception_4a_5_5, inception_4a_pool_1_1],
                                mode='concat', axis=4, name='inception_4a_output')
    ...
    inception_4b_output = merge([inception_4b_1_1, inception_4b_3_3, inception_4b_5_5, inception_4b_pool_1_1],
                                mode='concat', axis=4, name='inception_4b_output')
    ...
    inception_4c_output = merge([inception_4c_1_1, inception_4c_3_3, inception_4c_5_5, inception_4c_pool_1_1],
                                mode='concat', axis=4, name='inception_4c_output')
    ...
    inception_4d_output = merge([inception_4d_1_1, inception_4d_3_3, inception_4d_5_5, inception_4d_pool_1_1],
                                mode='concat', axis=4, name='inception_4d_output')
